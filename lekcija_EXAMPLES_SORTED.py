...
hippo = Animal("Henry",10)
hippo.description
sloth = Animal("Pera",34)
ocelot = Animal("Žika",45)
print hippo.health
print sloth.health
print ocelot.health
...
my_cart = ShoppingCart("Davor Svilar")
my_cart.add_item("Fruit",34)
my_cart.add_item("Vegetable",56)
print my_cart
